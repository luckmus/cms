      ...
      try
          {
                    ...
                    if ((res.price==null) || (res.price==0)){
                        jqAlert('Курьерская доставка по данному адресу невозможна', null);
                    }else{
                        showCurrierInfo(res);
                    }
          }
...
$( "#bb_delivery_index" ).off('input');
    jqAlert('Произведено изменение индекса курьерской доставки. Во избежание не точных расчетов, необходимо вновь выбрать способ доставки',null);
